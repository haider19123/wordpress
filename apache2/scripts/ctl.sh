...
HTTPD_PIDFILE=/home/haider/wordpress-5.8.2-0/apache2/logs/httpd.pid



HTTPD="/home/haider/wordpress-5.8.2-0/apache2/bin/httpd -f /home/haider/wordpress-5.8.2-0/apache2/conf/httpd.conf"
if [ -f "/home/haider/wordpress-5.8.2-0/apps/bitnami/banner/disable-banner" ] ; then
...
. /home/haider/wordpress-5.8.2-0/apache2/bin/envvars
