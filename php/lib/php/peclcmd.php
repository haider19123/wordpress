...
if ('/home/haider/wordpress-5.8.2-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/haider/wordpress-5.8.2-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
